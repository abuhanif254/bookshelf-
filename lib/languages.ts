...
export const SUPPORTED_LANGUAGES: LanguageConfig[] = [
  {
    ...
    name: 'Bangla',
    nativeName: 'বাংলা',
    h1: 'বাংলা বই ও উপন্যাস (Free Bangla PDF Books)',
    seoTitle: 'Free Bangla PDF Books Download — বাংলা বই ও উপন্যাস | Bookshelf',
    seoDesc: 'Download verified free Bangla PDF books, Bengali literature, Rabindranath Tagore, Kazi Nazrul Islam, Humayun Ahmed, and Islamic books. 100% free Google Drive download.',
  ...
  },
  {
    ...
    name: 'Hindi',
    nativeName: 'हिन्दी',
    h1: 'हिन्दी किताबें एवं उपन्यास (Free Hindi PDF Books)',
    seoTitle: 'Free Hindi PDF Books Download — हिन्दी किताबें व कहानियां | Bookshelf',
    seoDesc: 'Download free Hindi PDF books, Premchand stories, Hindi literature, motivation, and spiritual books. 100% free direct Google Drive download.',
  ...
  },
  {
    ...
    name: 'Urdu',
    nativeName: 'اردو',
    h1: 'اردو کتب اور ادب (Free Urdu PDF Books)',
    seoTitle: 'Free Urdu PDF Books Download — اردو کتابیں اور ناول | Bookshelf',
    seoDesc: 'Download free Urdu PDF books, Mirza Ghalib, Allama Iqbal, Manto, Urdu novels, and Islamic literature. 100% free high-speed Google Drive download.',
  ...
  },
  {
    ...
    name: 'Spanish',
    nativeName: 'Español',
    h1: 'Libros Gratis en PDF en Español',
    seoTitle: 'Descargar Libros Gratis en PDF en Español | Bookshelf',
    seoDesc: 'Descarga miles de libros gratis en PDF en español. Literatura clásica, superación personal, negocios, y novelas completas. Descarga directa y segura.',
  ...
  },
  {
    ...
    name: 'Chinese',
    nativeName: '中文',
    h1: '中文经典与电子书 (Free Chinese PDF Books)',
    seoTitle: '免费中文PDF电子书下载 — 经典名著与学习资料 | Bookshelf',
    seoDesc: '海量优质免费中文PDF电子书下载，包含中国古典四大名著、现当代文学、商业与科技教程。高速网盘一键下载，完全免费。',
  ...
  },
  {
    ...
    name: 'English',
    nativeName: 'English',
    h1: 'Free English PDF Books & Handbooks',
    seoTitle: 'Download Free English PDF Books & Field Guides | Bookshelf',
    seoDesc: 'Download thousands of verified free English PDF books on productivity, programming, business, design, and science. 100% DRM-free.',
